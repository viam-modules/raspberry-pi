...
var PiGPIOErrorMap = map[int]string{
	...
	-2000: "PIGIF_BAD_SEND: could not send to pigpio",
	-2001: "PIGIF_BAD_RECV: no response to pigpio message",
	-2002: "PIGIF_BAD_GETADDRINFO: can't get socket address info for pigpio",
	-2003: "PIGIF_BAD_CONNECT: can't connect to pigpio",
	-2004: "PIGIF_BAD_SOCKET: can't create socket",
	-2005: "PIGIF_BAD_NOIB: can't find pigpio",
	-2006: "PIGIF_DUPLICATE_CALLBACK: callback already exists",
	-2007: "PIGIF_BAD_MALLOC: can't allocate memory",
	-2008: "PIGIF_BAD_CALLBACK: can't add callback",
	-2009: "PIGIF_NOTIFY_FAILED: can't notify pigpio",
	-2010: "PIGIF_CALLBACK_NOT_FOUND: callback not found",
	-2011: "PIGIF_UNCONNECTED_PI: can't find connected pi",
	-2012: "PIGIF_TOO_MANY_PIS: can't create more socket connections",
